...
\\
\\
Le choix de cette dernière n'est pas anodin, en effet comme dit précédemment le projet souffrait de difficulté pour le verrouillage des exigences, notre client changeais d’avis tout le temps et il fallait pouvoir suivre ce changement, l’utilisation de technologie web très stricte aurait compliqué la tâche, tandis que l’environnement \textbf{Power Platform} nous a donné une sorte de flexibilité et a permis de toujours corriger ainsi que modifier les fonctionnalités selon le besoin du client dans des délais records.
\\
